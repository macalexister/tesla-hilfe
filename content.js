...
const PAGES = {
  ...
  adac: {
    ...
    note: "Die ADAC-Ladekarte funktioniert an vielen Säulen, aber nicht an allen. Wenn sie nicht angenommen wird, ist die Säule nicht kaputt."
  },
  ...
  ewe: {
    ...
    note: "Die EWE-Go-Karte funktioniert an vielen Säulen, aber nicht an allen. Wenn sie nicht angenommen wird, ist die Säule nicht kaputt."
  },
  ...
  chargemap: {
    ...
    links: [["Chargemap öffnen", "https://chargemap.com/de-de"]]
  },
  ...
  "find-charge": {
    ...
    steps: [
      ...
      "Alternativ: Chargemap öffnen und in der Nähe suchen."
    ],
    links: [["Chargemap öffnen", "https://chargemap.com/de-de"]]
  },
  ...
  "cheap-charge": {
    ...
    links: [["Chargeprice öffnen", "https://www.chargeprice.app/"]]
  },
  ...
  emergency: {
    ...
    links: [
      ["📞 112 anrufen (Notruf)", "tel:112"],
      ["Tesla Pannenhilfe ansehen", "https://www.tesla.com/de_DE/support/roadside-assistance"],
      ["ADAC Pannenhilfe ansehen", "https://www.adac.de/services/pannenhilfe/"]
    ],
  ...
  apps: {
    ...
    cards: [
      ["🚗 Tesla", "Fahren, Navigation und Ladeplanung", "https://www.tesla.com/de_DE/support/tesla-app"],
      ["🗺️ Chargemap", "Ladestationen finden", "https://chargemap.com/de-de"],
      ["💶 Chargeprice", "Preise vergleichen", "https://www.chargeprice.app/"],
      ["💳 ADAC e-Charge", "Mit der ADAC-Ladekarte laden", "https://www.adac.de/rund-ums-fahrzeug/e-angebote/ladekarte/"],
      ["💳 EWE Go", "Mit der EWE-Go-Karte laden", "https://www.ewe-go.de/"]
    ],
